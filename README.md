...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/jolly-field-7ecf
```

A live public deployment of this template is available at [https://jolly-field-7ecf.templates.workers.dev](https://jolly-field-7ecf.templates.workers.dev)
